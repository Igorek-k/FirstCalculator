...
import java.awt.event.ActionListener;
    ...
    public class CalculatorEngine implements ActionListener {  // Создаем Класс CalculatorEngine, который наследует от Класса ActionListener.
        ...
        Calculator1 parent;  // Создаем переменную parent Класса Calculator.
        ...
        CalculatorEngine(Calculator1 parent) {
            this.parent = parent;
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            } else if (src == parent.buttonMultuplay) { // Текст программы для чтения Знака Умножения чисел.
                selectedAction = '*';
                currentResult = displayVaiue;
                parent.displayField.setText("");
